...
const MyQuestionsPage: React.FC = () => {
  ...
  const loadQuestions = async () => {
    setLoading(true);
    try {
      const response = await getMyQuestions(searchParams);
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">我的题目</h1>
            <p className="text-gray-600">
              共创建了 {questions.total} 道题目
            </p>
          </div>
          <button
          ...
          <>
            {questions.records.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">还没有创建题目</h3>
                <p className="text-gray-600 mb-4">开始创建你的第一道题目吧！</p>
                <button
                  onClick={() => navigate('/questions/create')}
                  className="px-6 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors"
                >
